...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8179487086:AAEHNdOJmfXOeS3cwhlhfCPW0O9yFMiRRcM';
...
$money2 = file_get_contents("data/txt/rubleall.txt"); #العملات الكليه#
$poi_money = file_get_contents("data/txt/pointall.txt"); #العملات المتبقيه#
$money = $money2 - $poi_money; #العملات المستهلكه#
...
$sendmy = count($BUYSSEND); #عدد عمليات تحويل العملات#
...
$consumers = $rubles-$Balance; #عدد العملات المستهلكه#
#_________________
if($numbuy==null){
$numbuy=0;
}
...
$chall = "llaa_55";
$useradmin = "ZDO_M";
$sim =-1002987444401; #القناة الرسمية
$PAY =-1002987444401; #الارقام المكتملة
$ess =-1002987444401; #عمليات شراء الارقام
$eer =-1002987444401; #اشعارات الايميلات وتحويل العملات
if($chat_id==1434538375){
$sudo=$chat_id;
}elseif($chat_id==1434538375){
$sudo=$chat_id;
}else{
$sudo==1434538375;
}
...
'chat_id'=>$chat_id,
'text'=>"
🖐*أهلا نورت بوت حجي قسورة* [$first](tg://user?id=$id) .♥️

- يجب الإشتراك بقناة البوت الرسمية لإستخدام البوت 📢

*- رابط القناة: @ZDO_M @llaa_55
...
'message_id'=>$message_id,
'text'=>"
🖐*اهلا* [$first](tg://user?id=$id) .♥️

- يجب الإشتراك بقناة البوت الرسمية لإستخدام البوت 📢

*- رابط القناة: https://t.me/llaa_55*
...
'reply_markup'=>json_encode([ 
'inline_keyboard'=>[ 
[['text'=>"⚜ قناة البوت ⚜",'url'=>"t.me/llaa_55"]]
]
])
]);
exit;
...
💸 - وتم إضافة $assignru عملات لحسابك بنجاح*
",
'parse_mode'=>"MarkDown",
]);
...
'chat_id'=>$chat_id,
'text'=>"
♐️ - نورت حجيي [$first](tg://user?id=$id) ؛ 🤍

*- في بوت @ZDO_M* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
💸 - وصل العملات المصروفه الى: *₽ $money* 💰
☑️ - عدد العملات المتبقى: *₽ $poi_money* 💰
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
'message_id'=>$message_id,
'text'=>"
• *نورت حجيي عزيزي في قسم التعليمات والشروط.*
...
- لفحص الرقم, أضغط على زر *رؤية الرقم في واتسأب* بعد شراء الرقم, سيقوم بتوجيهك إلى الواتساب, في حالة قال لك *إن رقم الهاتف هذا +967••• @ZDO_M ليس في واتسأب* هذا يعني أن الرقم جديد ولم يستخدم في واتسأب من قبل, *أما في الحالات الأخرى فهذا يعني أن الرقم مستخدم في واتسأب ولا نتحمل مسؤولية تفعيلة في أي حال من الأحوال.*
- قد لا تصل الأكواد إلى بعض الأرقام لتطبيق *واتسأب* , لذلك ياعزيزي يمكنك  إستخدام واتسأب أعمال قد تم نشرة في قناتنا على التيليجرام [إضغط هنا لتحميلها](t.me/llaa_55).
...
'text'=>"
👨‍✈️ *⁞ نورت حجيي* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. @ZDO_M* ⬇️
...
[['text'=>'💰︙ربح عملات مجانيه 🤑','callback_data'=>"assignment"]],
...
'message_id'=>$message_id,
'text'=>"
💸 *- إربح عملات الآن مجاناً* عبر مشاركة رابط البوت الى أصدقائك 👥
*- واحصل على $assignru عملات* مقابل كل شخص يقوم بالدخول إلى البوت عبر الرابط الخاص بك ✅
...
🥇 - [إضغط هنا](t.me/ZDO_M) لمعرفه *أسعار الشحن* 💰
...
'message_id'=>$message_id,
'text'=>"
☑️ - *نورت حجيي,* لشحن رصيدك قم بإرسال *الكرت الشحن الخاص ب البوت* والمكون من *8 أرقام وحروف* ⬇️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
'chat_id'=>$chat_id,
'text'=>"
☑️ - انت على وشك شحن كرت عملات في حسابك
...
'message_id'=>$message_id,
'text'=>"
☑️ *- تم تحصيل قيمة كرت الشحن وإضافة $amount عملات إلى حسابك بنجاح* ↪️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
[['text'=>'🔄︙تحويل عملات إلى حساب','callback_data'=>"SendCoin"]],
[['text'=>'☑️︙إستلام تحويل عملات','callback_data'=>"receiptpri"]],
...
☑️ *⁞ رقم عملية لإستلام العملات:* `$code`
...
☑️ *⁞ لإستلام هذه التحويل إذهب إلى قسم الإعدادات ومن ثم إلى قسم إستلام العملات وأرسل رقم العملية الذي ستستلمها من المحول*
",
'parse_mode'=>"MarkDown",
]);
bot('sendmessage',[
...
☑️ - رقم عملية إستلام العملات: *$code*
🔎 - رقم العمل: *$sendbot2*
🅿️ - رقم المرجع: *$idSend*
",
'parse_mode'=>"MarkDown",
...
'chat_id'=>$chat_id,
'text'=>"
☑️ *- تم إستلام حوالتك بقيمة ₽ $price عملات*
",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
]);
...
'chat_id'=>$eer,
'text'=>"
☑️ *- تم إستلام حوالة عملات على رقم $code*
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
'message_id'=>$message_id,
'text'=>"
☑️ - هذه قائمة *جميع عمليات التحويلات عملات في البوت.*
...
'chat_id'=>$idds,
'text'=>"
☑️ *- تم الموافقة على طلب إلغاء تحويل عملات برقم $idSend*
...
'chat_id'=>$idds,
'text'=>"
🚫 *- تم رفض طلب إلغاء تحويل عملات برقم $idSend*
",
'parse_mode'=>"MarkDown",
]);
$idd = $BUYSSEND[$order][idpric];
...
☑️ - عدد العملات المصروف: *₽ $consumers*
💠 - عدد العملات المتبقي: *₽ $Balance*
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
'message_id'=>$message_id,
'text'=>"
☑️ - هذه قائمة *جميع عمليات التحويلات العملات في البوت.*
⚜ - هذه العلامة *< ☑️ > تعني أن العملية تمت بنجاح* ، وهذه العلامة *< 🚫 > تعني أن العملية قد تم إلغائها* ، وهذه العلامة *< ⏰ > تعني أن العملية قيد الإنتظار.*
♻️ - إضغط على *رقم العلامة لإظهار باقي معلومات عن عملية التحويل الذي قمت بتحويلة.*
",
'parse_mode'=>"MarkDown",
...
'message_id'=>$message_id,
'text'=>"
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *@ZDO_M* ☑️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
...
🕰 - متواجدين في اغلب الاوقات حب. ❄️
❎ - يولل لاترسل كلام مو حلو. ☺️🖤
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
